...
│   └── ui/                      # ImGui shell: Dynamic-Island capsule, config panel, ScriptController, config binding (android&&cgo) / stub (desktop)
