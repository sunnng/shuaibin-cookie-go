...
- **README.md is stale** — it describes the removed `internal/bot` state architecture (Detect/Act/Next/Recover). Trust this file, `AGENTS.md`, and `docs/开发手册.md` instead.
